/* main.js - Alokah Ventures Limited
   - Single-file, modular-ready script
   - Keep this filename as `main.js` (you requested it named)
   - Console logs present for debugging (can be removed by setting DEBUG=false)
   - Each feature is wrapped in an init*() and guarded so it only binds once
*/
